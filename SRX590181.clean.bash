...
while read p; do
        ...
        samfile="${p}.sam"
        bamfile="${p}.bam"
        ./samtools sort -@ 15 -m 768M $samfile > $bamfile
        ./samtools index -@ 15 $bamfile
	addgroup="${p}.addgroup.bam"
	java -jar picard.jar AddOrReplaceReadGroups I=$bamfile O=$addgroup RGID=4 RGLB=lib1 RGPL=illumina RGPU=uni1 RGSM=20
